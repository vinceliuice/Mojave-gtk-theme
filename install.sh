...
ICON_VARIANTS=('-apple' '-normal' '-gnome' '-ubuntu' '-arch' '-manjaro' '-fedora' '-debian')
...
usage() {
  ...
  printf "  %-25s%s\n" "-i, --icon VARIANTS" "Specify activities icon variant(s) for gnome-shell [standard|normal|gnome|ubuntu|arch|manjaro|fedora|debian] (Default: arch variant)"
