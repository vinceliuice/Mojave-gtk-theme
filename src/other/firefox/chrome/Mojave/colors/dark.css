...
@media (prefers-color-scheme: dark) {
  :root {
	...
	/* Header bar */
	--gnome-headerbar-background: linear-gradient(to top, #383838 0%, #3e3e3e 50%, #434343 100%);
	--gnome-headerbar-border-color: #070707;
	--gnome-headerbar-box-shadow: inset 0 1px rgba(255, 255, 255, 0.15);
	--gnome-inactive-headerbar-background: linear-gradient(#313131, #313131);
  ...
  --gnome-headerbar-button-box-shadow: inset 0 1px rgba(255, 255, 255, 0.1);
	--gnome-headerbar-button-active-box-shadow: inset 0 1px rgba(255, 255, 255, 0.1);
	...
	--gnome-headerbar-button-active-background: linear-gradient(to top, #787878 0%, #868686 100%);
  ...
  --gnome-headerbar-button-active-box-shadow: inset 0 1px rgba(255, 255, 255, 0.1);
	...
	/* URL bar */
	--gnome-urlbar-background: linear-gradient(#616161, #585858);
	--gnome-urlbar-border-color: #282828;
	--gnome-urlbar-box-shadow: inset 0 0 0 1px rgba(21, 83, 158, 0);
	--gnome-urlbar-color: #ffffff;
	--gnome-inactive-urlbar-background: linear-gradient(#303030, #303030);
